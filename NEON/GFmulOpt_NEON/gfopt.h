...
#define MAX_LEN 100000/WORD_LEN
...
#define fprint_TC3_128(fp, function_name, len) {\
    if(len%3 == 0 && len >= 6) fprint_TC3_128_3k(fp, function_name, len);\
    else if (len%3 == 1 && len >= 13) fprint_TC3_128_3kp1(fp, function_name, len);\
...
#define fprint_TC3_64(fp, function_name, len) {\
    if(len%3 == 0) fprint_TC3_64_3k(fp, function_name, len);\
    else if (len%3 == 1) fprint_TC3_64_3kp1(fp, function_name, len);\
    else if (len >= 8) fprint_TC3_64_3kp2(fp, function_name, len);\
...
void gf2x_codegen(uint32_t len);
